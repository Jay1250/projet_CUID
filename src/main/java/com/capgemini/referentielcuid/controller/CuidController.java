...
public class CuidController {
	...
	public List<Cuid> listeCuid() throws NotFoundException, ServiceException{
	...
	public Optional<Cuid> afficherUnCuid(@PathVariable String cuid) throws NotFoundException, ServiceException{
	...
	public List<Cuid> afficherUnCuidAvecContrat(@PathVariable int contratId) throws NotFoundException, ServiceException{
	...
	public ResponseEntity<Boolean> supprimerCuid(@PathVariable String cuid) throws ServiceException {
